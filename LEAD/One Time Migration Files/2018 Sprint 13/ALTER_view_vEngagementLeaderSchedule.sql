...
/****** Object:  View [dbo].[vEngagementLeaderSchedule]    Script Date: 7/11/2018 3:49:34 PM ******/
SET ANSI_NULLS ON
GO
...
--John louie CHan				    1.2							[2018 Sprint 13]			US159200 - setting changes for letting priority be nullable
...
AS
 SELECT e.[Id]
	  ...
	  ,'Div: ' + dv.[Name] + ' Team: ' + t.[Team] + ' Pri: ' + ISNULL(p.[Priority], ' ') + ' Rank: ' + tr.[Ranking] [TeamInfo]
	  ,dv.[Name] [Division]
	  ,dv.[Description] [DivisionDescription]
	  ,t.[Team]
	  ,ISNULL(p.[Priority], ' ') [StrategicPriority]
  ...
  LEFT JOIN [dbo].[Priority] p ON e.[StrategicPriorityFk] = p.[Id]
