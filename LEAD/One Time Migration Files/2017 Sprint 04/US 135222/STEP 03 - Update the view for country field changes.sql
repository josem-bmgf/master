...
-- Updated the Country field to use a function for getting all the values of country field.

USE [LEAD]
GO

/****** Object:  View [dbo].[vEngagementLeaderSchedule]    Script Date: 2/19/2017 6:14:20 PM ******/
SET ANSI_NULLS ON
GO
