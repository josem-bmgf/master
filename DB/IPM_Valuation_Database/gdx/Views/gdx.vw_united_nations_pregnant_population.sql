CREATE VIEW [gdx].[vw_united_nations_pregnant_population] AS
SELECT
...
t1.pregnant_women_population_qty AS 'measure_point_estimate'
FROM [staging].[united_nations_pregnant_population] t1
